...
import Clases.producto.tipos.Carne;
...
public class PanelCarnes extends javax.swing.JPanel {
    ...
    private static ArrayList<Carne> listaCarnes = new ArrayList<>();

    public static ArrayList<Carne> getListaCarnes() {
        return listaCarnes;
    }

    public static void setListaCarnes(ArrayList<Carne> listaCarnes) {
        PanelCarnes.listaCarnes = listaCarnes;
    }
    ...
    private DefaultListModel iniciarLista(ArrayList listaExterna) {
        ...
        ArrayList<Carne> listaLocal = new ArrayList<>();
    ...
    private void verProducto(){
        ...
        PantallaVerProducto.setIndex(listaCarnes.get(listaPrincipal.getSelectedIndex()).getId());
