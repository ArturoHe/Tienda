...
import Clases.producto.tipos.Otro;
...
public class PanelOtros extends javax.swing.JPanel {
    ...
    private static ArrayList<Otro> listaOtros = new ArrayList<>();

    public static ArrayList<Otro> getListaOtros() {
        return listaOtros;
    }

    public static void setListaOtros(ArrayList<Otro> listaOtros) {
        PanelOtros.listaOtros = listaOtros;
    }
    ...
    private DefaultListModel iniciarLista(ArrayList listaExterna) {
        ...
        ArrayList<Otro> listaLocal = new ArrayList<>();
    ...
    private void verProducto(){
        ...
        PantallaVerProducto.setIndex(listaOtros.get(listaPrincipal.getSelectedIndex()).getId());
