 ...
 * @author Arturo
 */
public class PanelVerduras extends javax.swing.JPanel {
    
    private static ArrayList<Verdura> listaVerduras = new ArrayList<>();

    public static ArrayList<Verdura> getListaVerduras() {
        return listaVerduras;
    }

    public static void setListaVerduras(ArrayList<Verdura> listaVerduras) {
        PanelVerduras.listaVerduras = listaVerduras;
    }
    ...
    private DefaultListModel iniciarLista(ArrayList listaExterna) {
        ...
        ArrayList<Verdura> listaLocal = new ArrayList<>();
    ...
    private void verProducto(){
        ...
        PantallaVerProducto.setIndex(listaVerduras.get(listaPrincipal.getSelectedIndex()).getId());
