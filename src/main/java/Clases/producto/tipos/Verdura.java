 ...
 * @author Arturo
 */
public final class Verdura extends ProductoVerificacion {
    ...
    public Verdura(boolean totalmenteOrganico, int peso, String especie, boolean productoImportado, String nombre, String descripcion, int id, String tipo, int precio) {
    ...
    public Verdura(boolean totalmenteOrganico, int peso, String especie, boolean productoImportado, String paisdeImportacion, String nombre, String descripcion, int id, String tipo, int precio) {
